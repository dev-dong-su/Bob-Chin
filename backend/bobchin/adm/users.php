            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?=$row['name']?></td>
                        <td><?=$row['email']?></td>
                        <td><img width="40px" height="40px" src="<?=$row['photo']?>"></td>
                        <td><?=$row['auth_level']?></td>
                        <td><?=$row['age']?></td>
                        <td><?=$row['last_renew']?></td>
                        <td>
                            <a href="action/banuser.php?id=<?=$row['userid']?>" class="btn btn-outline-danger"><i class="fas fa-minus-circle"></i></a>
                        </td>
                    </tr>
                    <?
                        }
